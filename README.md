...
## ランディングページ(2021年1〜3月)
ランディングページでは、HTML, CSS, Javascriptで基本的なWeb制作をの学習を進めました。
...
ベースはプログラミング学習サイトのSNSサービスですが、Userをadministratorとguestのみに絞り、
...
こちらもまだまだ開発途中ですが、インフラやテスト、仮想環境などより実戦に近い技術を実装していきます。


引き続き、実際にサービスとして使えるようブラッシュアップをしていきます。
ありがとうございました！
