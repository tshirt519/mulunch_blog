...
本来はNode.jsやExpress、Reactなどを学習しており、Javascriptを深く学んでいく
機会とする予定でしたが、志望企業の募集要項を確認し、Railsに転校することに決めました。  
...
SNSでのシェア機能も実装しています。まだまだ開発途中で、足元ではAWS S3でのファイル処理の実装中、
最終的に参考サイトをベースに機能を加え、ViewをReactで表示できるようにするところまで完成を目指します。
